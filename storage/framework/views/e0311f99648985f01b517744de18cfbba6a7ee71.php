            ...
            <div id="parentHorizontalTab">
                <div class="resp-tabs-container hor_1">
                        ...
                        <div class="card col-md-12">
                            <div class="card-body">
                                ...
                                <div class="row mb-3 text-center float-right">
                                    <div class="col-sm-9">
                                        <img src="<?php echo e(asset($product->img)); ?>" alt="" style="height:150px;width:100px" class="img-responsive mt-5">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row mb-3 text-center">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="form-control-static">Rs.<?php echo e($product->price); ?> </p>
                        ...
                        <div class="checkout-right-basket">
                            ...
                            <input type="hidden" id="abc" value="<?php echo e($product->price); ?>">
                            <input type="hidden" id="price" value="<?php echo e($product->price); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice\e-commerce\resources\views/payment.blade.php ENDPATH**/ ?>