		...
		<div class="main-sidebar-header main-container-1">
			<div class="main-sidebar-body main-body-1">
				...
				<ul class="menu-nav nav">
					<li class="nav-header"><strong class="nav-label">Dashboard</strong></li>
...
<!-- END SIDEBAR --><?php /**PATH E:\practice\e-commerce\resources\views/Admin/sidebar.blade.php ENDPATH**/ ?>