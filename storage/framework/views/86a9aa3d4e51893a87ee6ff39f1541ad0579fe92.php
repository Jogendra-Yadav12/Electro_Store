								...
								<form class="card custom-card" action="../upduser/<?php echo e($address[0]['id']); ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<input type="password" class="form-control" placeholder="password" name="password" value="<?php echo e($address[0]['password']); ?>" required>
										</div>
                                        <div class="form-group">
											<label class="tx-medium">Type</label><span> (Must write in lower letter)</span>
											<input type="text" class="form-control" placeholder="type" name="type" value="<?php echo e($address[0]['type']); ?>" required>
										</div>
									</div>
