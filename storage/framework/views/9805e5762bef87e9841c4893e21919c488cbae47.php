...
<div class="main-content side-content">
										...
										<div class="row">
													...
													<div class="col-md-7 offset-md-1 col-sm-9 col-8">
														<div class="product-carousel">
															<div id="carousel" class="carousel slide" data-bs-ride="false">
																<div class="carousel-inner">
																	<div class="carousel-item active"><img src="<?php echo e(asset($product->img)); ?>" alt="img" class="img-fluid mx-auto d-block" style="height:400px;width:700px;object-fit:conatin"></div>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="col-xl-6 col-lg-12 col-md-12">
												<div class="mt-4 mb-4">
													...
													<h5 class="mb-2">Price : <span class="text-muted me-2"><del></del></span> <b>Rs <?php echo e($product->price); ?></b></h5>
            ...
            <!-- END MAIN-CONTENT -->
<?php echo $__env->make('Admin/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice\e-commerce\resources\views/Admin/product-details.blade.php ENDPATH**/ ?>