           ...
           <hr>
            <ul class="list-group">
                <li class="list-group-item mt-3">
                    <form method="post" action="<?php echo e(url('updatepass')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice\e-commerce\resources\views/updatepass.blade.php ENDPATH**/ ?>