...
<div class=" mt-5">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title text-center px-5 ml-5 mr-5">Verify OTP</h3>
          </div>
          <div class="card-body">
            <ul class="list-group">
                <li class="list-group-item mt-3">
                    <form method="get" action="<?php echo e(url('verifyotp')); ?>">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH E:\practice\e-commerce\resources\views/otp.blade.php ENDPATH**/ ?>