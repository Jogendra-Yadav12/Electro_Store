...
<footer>
		...
		<div class="agile-sometext py-md-5 py-sm-4 py-3">
			<div class="container">
				...
				<div class="sub-some child-momu mt-4">
					...
					<ul>
						<li>
							<img src="<?php echo e(asset('asset/images/pay2.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay5.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay1.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay4.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay6.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay3.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay7.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay8.png')); ?>" alt="">
						</li>
						<li>
							<img src="<?php echo e(asset('asset/images/pay9.png')); ?>" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script data-cfasync="false" src="<?php echo e(asset('asset/js/email-decode.min.js')); ?>"></script><script src="<?php echo e(asset('asset/js/jquery-2.2.3.min.js')); ?>"></script>
	<!-- //jquery -->
	...
	<script src="<?php echo e(asset('asset/js/jquery.magnific-popup.js')); ?>"></script>
	...
	<!-- scroll seller -->
	<script src="<?php echo e(asset('asset/js/scroll.js')); ?>"></script>
	<!-- //scroll seller -->
	<!-- Include jQuery via CDN -->
<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
	<!-- smoothscroll -->
	<script src="<?php echo e(asset('asset/js/SmoothScroll.min.js')); ?>"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="<?php echo e(asset('asset/js/move-top.js')); ?>"></script>
	<script src="<?php echo e(asset('asset/js/easing.js')); ?>"></script>
	<script>
...
<script>
(function(){var js = "window['__CF$cv$params']={r:'837f89be1e7c381b',t:'MTcwMjk4Nzc4MS4zMzcwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='<?php echo e(asset('asset/js/main.js')); ?>',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};
}})();
</script></body>
...
</html><?php /**PATH E:\practice\e-commerce\resources\views/components/footer.blade.php ENDPATH**/ ?>