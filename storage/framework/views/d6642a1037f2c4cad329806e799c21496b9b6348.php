...
<?php $component = App\View\Components\Productdetail::resolve(['product' => $ca,'title' => 'Computer Accessories','brand' => $brand,'wish' => $wish,'count' => $count] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice\e-commerce\resources\views/computer.blade.php ENDPATH**/ ?>