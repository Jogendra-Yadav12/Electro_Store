...
<body>
<script src="<?php echo e(asset('asset/js/monetization.js')); ?>" type="text/javascript"></script>
<script>
(function(){
...
<body><link rel="stylesheet" href="<?php echo e(asset('asset/css/font-awesome.min.css')); ?>">
<!-- New toolbar-->
<style>
* {
  ...
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif;
	...
	<!-- shop locator (popup) -->
	<!-- //header-bottom --><?php /**PATH E:\practice\e-commerce\resources\views/components/header.blade.php ENDPATH**/ ?>