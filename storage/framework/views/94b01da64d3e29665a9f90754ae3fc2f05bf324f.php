    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 welcome-right-top mt-lg-0 mt-sm-5 mt-4">
                <img src="<?php echo e(asset('asset/images/ab.jpg')); ?>" class="img-fluid" alt=" ">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-sm-6 med-testi-grid">
                ...
                <div class="row med-testi-left my-5">
                    <div class="col-lg-2 col-3 w3ls-med-testi-img">
                        <img src="<?php echo e(asset('asset/images/user.jpg')); ?>" alt=" " class="img-fluid rounded-circle" />
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\practice\e-commerce\resources\views/aboutus.blade.php ENDPATH**/ ?>