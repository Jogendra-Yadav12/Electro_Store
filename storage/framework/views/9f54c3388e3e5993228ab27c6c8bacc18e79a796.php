				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="<?php echo e(asset('asset/images/logo2.png')); ?>" alt="Logo" class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="<?php echo e(url('search')); ?>" method="GET">
...
</html><?php /**PATH E:\practice\e-commerce\resources\views/layouts/app.blade.php ENDPATH**/ ?>