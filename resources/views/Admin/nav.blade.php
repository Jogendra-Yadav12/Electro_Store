					...
					<div class="main-header-left">
						...
						<div class="hor-logo">
							<a class="main-logo" href="index.html">
								<img src="{{asset('admin/img/brand/logo.png')}}" class="header-brand-img desktop-logo" alt="logo">
								<img src="{{asset('admin/img/brand/logo-light.png')}}" class="header-brand-img desktop-logo-dark"
									alt="logo">
							</a>
						</div>
					</div>
									...
									<div class="dropdown main-profile-menu">
										<a class="d-flex" href="javascript:void(0);">
											<span class="main-img-user"><img alt="avatar"
													src="{{asset('admin/img/users/1.jpg')}}"></span>
										</a>
